...
import { Domain, RoleWithJD } from "@/components/learningpath/domains";
import { Button } from "@/components/ui/button";
import { ArrowLeft, ChevronDown, ChevronUp } from "lucide-react";
import { useState } from "react";
import { domainData } from "@/components/learningpath/ExplorationBranchCards";
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        animate={{ y: [0, 200], scale: [1, 0.5], opacity: [1, 0] }} 
        ...
        <div className="relative max-w-6xl mx-auto min-h-[3200px] overflow-hidden">
          ...
          {[...Array(27)].map((_, i) => (
            <motion.div 
              ...
              transition={{ delay: 1.5 + i * 0.04, duration: 0.2 }} 
              style={{
                width: "16px",
                height: "2px",
                background: "#451a03",
          ...
          {[...Array(8)].map((_, i) => (
            <motion.div 
              ...
              transition={{ delay: 3.2 + i * 0.1, duration: 1 }} 
              style={{
...
const TimelineBranch = ({
  ...
  return (
    ...
    >
      {/* Branch connector */}
      <svg 
        className="absolute top-0 pointer-events-none z-0 hidden md:block" 
        style={{
          left: isLeft ? "10%" : "50%",
          width: isLeft ? "40%" : "40%",
          height: "120px"
      ...
      >
        <motion.path 
          d={isLeft ? "M 400 60 Q 200 60, 0 100" : "M 0 60 Q 200 60, 400 100"} 
          fill="none" 
          stroke="#78350f" 
          strokeWidth="6" 
          strokeLinecap="round" 
      ...
      <motion.div 
        ...
        className={`relative mx-auto md:mx-0 ${isLeft ? "md:mr-auto" : "md:ml-auto"} w-full max-w-md md:max-w-none md:w-5/12`} 
        style={{
      ...
      >
        ...
        <motion.div 
          ...
          className="hidden md:block md:absolute md:top-16 w-8 h-8 rounded-full border-4 border-background z-10" 
          style={{
