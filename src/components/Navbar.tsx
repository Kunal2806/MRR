          ...
          <div className="hidden md:flex items-center space-x-4 relative">
            {user ? (
              <div className="relative">
                ...
                {/* Dropdown */}
                {showDropdown && (
                  <div className="absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-lg gap-4">
                    <Link
                      href="/dashboard"
                      className="
                        flex items-center w-full px-4 py-2 
                        text-sm font-medium text-[#6347EB] 
                        bg-white
                        hover:bg-[#f4f1ff] 
                        rounded-lg 
                    ...
                    <button
                      ...
                      className="flex items-center w-full px-4 py-2 text-sm text-red-600 border-2 border-transparent hover:border-red-600 hover:bg-gray-100 rounded-md"
                    >
